...
1. `Fork python-cookiepatcher on GitHub <https://github.com/ionelmc/python-cookiepatcher/fork>`_.
2. Clone your fork locally::

    git clone git@github.com:your_name_here/python-cookiepatcher.git
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will 
       `run the tests <https://travis-ci.org/ionelmc/python-cookiepatcher/pull_requests>`_ for each change you add in the pull request.
