...
def save_context(context, **kwargs):
    project_dir = yield
    with open(os.path.join(project_dir, '.cookiecutterrc'), 'w', encoding='utf8') as fh:
        fh.write("# Generated by cookiepatcher, a small shim around cookiecutter (pip install cookiepatcher)\n\n")
